    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptions', models.CharField(blank=True, max_length=500, null=True)),
                ('group', models.ManyToManyField(related_name='students_in_group', to='configapp.groupstudent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='homeworks', to='configapp.student')),
