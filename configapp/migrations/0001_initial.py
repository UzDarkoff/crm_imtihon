    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptions', models.CharField(blank=True, max_length=500, null=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='groups', to='configapp.course')),
        ...
        migrations.AddField(
            model_name='user',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students_in_group', to='configapp.groupstudent'),
        ),
        migrations.CreateModel(
            name='Homework',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptions', models.CharField(blank=True, max_length=500, null=True)),
                ('group', models.ManyToManyField(related_name='students_group', to='configapp.groupstudent')),
        ...
        migrations.AddField(
            model_name='groupstudent',
            name='teacher',
            field=models.ManyToManyField(related_name='groups_taught', to='configapp.teacher'),
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
